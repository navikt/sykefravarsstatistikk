...
const proxyConfig = {
    ...
    pathRewrite: (path) => {
        return path.replace(FRONTEND_IA_TJENESTER_METRIKKER_PROXY_PATH, BACKEND_IA_TJENESTER_METRIKKER_PATH);
    },
    router: async (req) => {
...
const iaTjenesterMetrikkerProxy = createProxyMiddleware(FRONTEND_IA_TJENESTER_METRIKKER_PROXY_PATH, proxyConfig);
