...
import illustrasjon from './midlertidig.svg';
    ...
    return (
        <PanelBase className="infopanel">
            ...
            <div className="infopanel__tekst-wrapper">
                ...
                <Normaltekst>
                    NAV samler statistikk om sykefraværet i Norge. Her kan du sammenligne din virksomhet
                    med næringen og sektoren virksomheten tilhører.
                </Normaltekst>
            </div>
        </PanelBase>
    );
