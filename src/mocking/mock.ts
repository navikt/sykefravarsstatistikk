...
//const mockSammenligning = () => fetchMock.get('express:/sykefravarsstatistikk/api/:orgnr/sammenligning', {status: 403, body: "You are not authorized to view this resource"});
