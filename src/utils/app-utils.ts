...
const sistOppdatert = new Date('2021-12-02');
const nesteOppdatering = new Date('2022-03-03');
export const periodeFra = new Date('2020-10-01');
export const periodeTil = new Date('2021-09-30');
