...
const sistOppdatert = new Date('2021.03.04');
const nesteOppdatering = new Date('2021.06.04');
export const periodeFra = new Date('2020.01.01');
export const periodeTil = new Date('2020.12.31');
