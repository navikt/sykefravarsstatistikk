...
it('Trigger AnalyticsClient#logEvent når sendAnalytics blir kalt', () => {
    act(() => {
        render(<MemoryRouter initialEntries={['/sykefravarsstatistikk/?bedrift=910969439']}><App
            analyticsClient={amplitudeMockClient} />
        </MemoryRouter>);
    });
...
it('sidevisning event kalles med user properties', () => {
    const ekstradata: Ekstradata = {
        antallAnsatte: '5-19',
        bransje: 'Dummybransje',
        korttidSiste4Kvartaler: SykefraværVurdering.OVER,
        langtidSiste4Kvartaler: SykefraværVurdering.UNDER,
        næring2siffer: '',
        prosent: '6-8',
        sammenligning: '',
        sektor: 'privat',
        sykefraværSiste4Kvartaler: SykefraværVurdering.MIDDELS,

    };
    const data: Sykefravarsstatistikk = {
        ...
        enhetsInformasjon: {
            ...
            restOverordnetEnhet: {
                status: RestStatus.Suksess,
                data: { orgnr: '111111111', institusjonellSektorkode: { kode: '6100', beskrivelse: 'idk' } },
            },
        },
        featureToggles: {
        ...
        const innhold =
            render(
                <MemoryRouter initialEntries={['/sykefravarsstatistikk/?bedrift=910969439']}>
                    <AppContent {...data} analyticsClient={amplitudeMockClient} ekstradata={ekstradata} />
                </MemoryRouter>,
            );
    });
    expect(amplitudeMockClient.setUserProperties).toHaveBeenCalledTimes(1);
    expect(amplitudeMockClient.setUserProperties).toHaveBeenCalledWith(ekstradata);
});
