...
export const lagHistorikkMedLandSektorOgNæringMenIngenDataForOverordnetEnhetEllerUnderenhet =
    (): KvartalsvisSykefraværshistorikk[] => {
        return [
...
export const lagHistorikkMedLikHistorikkForUnderenhetOgOverordnetEnhet = () => {
    ...
    return [
        ...
        },
        {
            ...
            label: 'FLESK OG FISK AS',
            kvartalsvisSykefraværsprosent:
                kvartalsvisSykefraværsprosentForBådeVirksomhetOgOverordnetEnhet,
        },
        {
            type: SykefraværshistorikkType.OVERORDNET_ENHET,
            label: 'THE FISHING GROUP',
